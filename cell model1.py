...
#
    ...
    tempa8 = 1.0+np.exp(0.0896*(Y1-EK))
    ...
    alp25 = 0.18064*np.exp(0.03577*(Y1+30.0))*4.0
    bet25 = 0.3956*np.exp(-0.06237*(Y1+30.0))*4.0
...
#           taua2 = (0.493*exp(-0.0629*Y(1))+2.058)
    ...
    + np.exp(-0.0629*(Y1+40.0)))+2.058
    taui2 = 1200.-170./(1.0+np.exp((45.2+Y1)/5.7))
    #
